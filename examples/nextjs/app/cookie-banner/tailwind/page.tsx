...
export default function TailwindCookieBannerPage() {
	...
	return (
		<main>
			...
			<CookieBanner.Card className="fixed bottom-0 inset-x-0 z-50 p-4 bg-black/10 backdrop-blur-sm mx-auto max-w-2xl rounded-xl border bg-white shadow-2xl">
				...
				<CookieBanner.Footer className="flex justify-end gap-2">
					...
					<CookieBanner.CustomizeButton className="rounded-md border border-gray-300 px-4 py-2 text-sm hover:bg-gray-50 transition-colors" />
