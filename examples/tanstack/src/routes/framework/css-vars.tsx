...
export const Route = createFileRoute("/framework/css-vars")({
...
function RouteComponent() {
	return (
        ...
        .policy-css-vars [data-op-section] {
          margin-bottom: var(--policy-section-gap);
          padding-bottom: var(--policy-section-gap);
          border-bottom: 1px solid var(--policy-section-border);
        }
        .policy-css-vars [data-op-heading] {
          font-size: var(--policy-heading-size);
          font-weight: var(--policy-heading-weight);
          color: var(--policy-heading-color);
          margin-bottom: 1rem;
        }
        .policy-css-vars [data-op-paragraph] {
          font-size: var(--policy-text-size);
          color: var(--policy-text-color);
          line-height: 1.625;
          margin-bottom: 0.75rem;
        }
        .policy-css-vars [data-op-list] {
      ...
      `}</style>
			<div className="policy-css-vars max-w-2xl mx-auto py-12 px-6">
				<PrivacyPolicy />
			</div>
		</>
	);
