...
Add privacy fields to your config — the privacy policy is auto-detected from the presence of fields like `dataCollected`, `legalBasis`, `retention`, and `userRights`:
