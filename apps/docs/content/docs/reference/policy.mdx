...
**Type:** `{ underAge: number; noticeUrl?: string }`

Optional configuration for a children’s privacy section. If supplied, a new
"Children’s Privacy" section will appear in the generated document
mentioning the minimum age and (optionally) a URL to a parental notice.
