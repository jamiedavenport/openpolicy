...
- [`@opencookies/scanner`](/docs/opencookies/scanner) — underlying detection engine, suppression syntax, custom rules
- [`@opencookies/core`](/docs/opencookies/core) — runtime store and `<ConsentGate>` / `has()` shapes the scanner looks for
