...
If you're using a framework, install one of the adapters instead and read this for the shared concepts: [react](/docs/opencookies/react) · [vue](/docs/opencookies/vue) · [solid](/docs/opencookies/solid) · [svelte](/docs/opencookies/svelte).
...
- [`@opencookies/react`](/docs/opencookies/react), [`@opencookies/vue`](/docs/opencookies/vue), [`@opencookies/solid`](/docs/opencookies/solid), [`@opencookies/svelte`](/docs/opencookies/svelte) — framework adapters
- [`@opencookies/scanner`](/docs/opencookies/scanner) — static AST detection of ungated cookie / vendor calls
- [`@opencookies/vite`](/docs/opencookies/vite) — Vite plugin that runs the scanner during dev and CI
