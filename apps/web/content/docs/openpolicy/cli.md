...
See [Configuration](/docs/openpolicy/configuration) for the shape of `openpolicy.ts` and [Auto-collect](/docs/openpolicy/policies/auto-collect) for declaring data collection inline in your source.
