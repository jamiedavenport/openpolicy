...
## What PolicyCloud adds on top

The open-source pieces are still doing the work. PolicyCloud is the place to see them, version them, and prove what happened.
...
- **Open source — $0.** Self-hosted. Apache-2.0. Yours forever. Includes OpenPolicy, OpenCookies, Vite plugin, CLI.
...
- Underlying OSS: [OpenPolicy](https://policystack.dev/openpolicy.md), [OpenCookies](https://policystack.dev/opencookies.md)
